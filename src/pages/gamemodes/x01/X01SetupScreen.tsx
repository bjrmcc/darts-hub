...
export default function X01SetupScreen() {
  ...
  const { open: infoOpen, manual: infoManual, close: closeInfo, dismiss: dismissInfo, reopen: openInfo } = useInfoModal('x01', state?._from === 'hub');
  ...
  return (
    <div className="page">
      {infoOpen && <InfoModal content={GAME_INFO.x01} onClose={closeInfo} onDismiss={dismissInfo} showDismiss={!infoManual} />}
