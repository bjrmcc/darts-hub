...
export default function CricketSetupScreen() {
  ...
  const { open: infoOpen, manual: infoManual, close: closeInfo, dismiss: dismissInfo, reopen: openInfo } = useInfoModal('cricket', state?._from === 'hub');
  ...
  return (
    <div className="page">
      {infoOpen && <InfoModal content={GAME_INFO.cricket} onClose={closeInfo} onDismiss={dismissInfo} showDismiss={!infoManual} />}
