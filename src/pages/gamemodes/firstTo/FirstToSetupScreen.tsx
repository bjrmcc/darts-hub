...
export default function FirstToSetupScreen() {
  ...
  const { open: infoOpen, manual: infoManual, close: closeInfo, dismiss: dismissInfo, reopen: openInfo } = useInfoModal('firstTo', state?._from === 'hub');
  ...
  return (
    <div className="page">
      {infoOpen && <InfoModal content={GAME_INFO.firstTo} onClose={closeInfo} onDismiss={dismissInfo} showDismiss={!infoManual} />}
